    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav ml-auto my-2 my-lg-0">
                <li class="nav-item">
                    <img src="${sessionScope.member.image}" class="nav-profile-img">
                </li>
                <li class="nav-item my-auto ml-2">
                    <a class="nav-link js-scroll-trigger text-white" data-toggle="modal" data-target="#login">${sessionScope.member.name}</a>
                </li>
